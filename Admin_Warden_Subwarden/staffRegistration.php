                                    ...
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="emp_id" id="emp_id" class="form-control" required="required" disabled>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="emp_nic" id="emp_nic" class="form-control" required="required">
                                                </div>
                                            </div>
