                    ...
                    <div class="col-md-12">
                        ...
                        <form method="post" action="" name="registration" class="form-horizontal">
                                    ...
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="search" name="stu_nic" id="stu_nic" class="form-control" required="required">
                                                </div>
                                                <button type="button" name="stu_search" id="stu_search" class="btn btn-primary"> Search </button>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="stu_batch" id="stu_batch" class="form-control" required="required">
                                                        <option value="b20">20 Btach</option>
                                                        <option value="b19">19 Btach</option>
                                                        <option value="b18">18 Btach</option>
                                                        <option value="b17">17 Btach</option>
                                                        <option value="b16">16 Btach</option>
                                                    </select>
                                                </div>
                                            </div>
                            ...
                            <div class="col-sm-8 col-sm-offset-4">
                                ...
                                <button type="button" name="stu_delete" id="stu_delete" class="btn btn-primary"> Delete </button>
                            </div>
                        </form>
                    </div>
                </div>
