    ...
    <div class="welcome-message">
        <div class="wrap-info">
            <div class="information">
                <h1 class="animated fadeInDown">University of Peradeniya
                    <hr align="center" width="52%">
        ...
        <div class="row">
            <div class="col-sm-7 col-md-8">
                <div class="embed-responsive embed-responsive-16by9 wowload fadeInLeft">
                    <video class="embed-responsive-item video" src="videos/University Of Peradeniya.mp4" width="100%" height="400" webkitallowfullscreen mozallowfullscreen allowfullscreen controls loop autoplay="autoplay">
                    </video>
                </div>
            </div>
            <div class="col-sm-5 col-md-4 about">
                <div class="row">
                    <div>
                        <p>University of Peradeniya is a leading university in Sri Lanka which facilitates about 9605 undergraduates in 9 different faculties.<br><br>
                            ...
                            5500 undergraduates which is nearly 55% of the student population.</p>
                    </div>
