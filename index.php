...
<!-- banner -->
<div class="banner">    	   
    <img src="images/photos/banner.jpeg"  class="img-responsive" alt="slide">
    <div class="welcome-message">
        <div class="wrap-info">
            <div class="information">
                <h1  class="animated fadeInDown">University of Peradeniya<hr>Hostel Management System</h1>
...
<div class="col-sm-7 col-md-8">
    <div class="embed-responsive embed-responsive-16by9 wowload fadeInLeft"><iframe  class="embed-responsive-item" src="videos/University of Peradeniya.mp4" width="100%" height="400" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
</div>
<div class="col-sm-5 col-md-4">
<div class="row">
              <div><p><br><br>University of Peradeniya is a leading university in Sri Lanka which facilitates about 9605 undergraduates in 9 different faculties.<br><br>
	Student Services Branch in the University of Peradeniya provides a comprehensive service to selected number of students from each faculty by administrating 
    and allocating 20 hostels in the university premises.<br><br>There are 10 male hostels, 8 female hostels and 2 bikku hostels which provide accommodation for around
     5500 undergraduates which is nearly 55% of the student population.</p></div>
